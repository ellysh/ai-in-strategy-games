...
11 мая 1997 года шахматный компьютер [Deep Blue](https://ru.wikipedia.org/wiki/Deep_Blue) победил действующего чемпиона мира по шахматам Гарри Каспарова. Но история разработки этого компьютера началась на много лет раньше.
...
В середине 1980-х университете Карнеги Мелоун сформировалась группа студентов и преподавателей для разработки шахматного компьютера [HiTech](https://www.chessprogramming.org/HiTech). Руководил проектом заслуженный эксперт по шахматным программам профессор [Ханс Берлинер](https://www.chessprogramming.org/Hans_Berliner).

У проекта HiTech была та же идея, что и у Belle — собрать специализированный компьютер на стандартных чипах серийного производства. В отличие от Belle эти чипы представляли собой СБИС.

Особенность проекта заключалась не в оборудовании, а в новом методе поиска. Его разработал Берлинер в начале 1980-х и назвал B* (по аналогии с типами A и B Шеннона). Это выборочный поиск, который просчитывает глубже перспективные ходы. В то же время он сокращает просчёт менее перспективных ходов.

Для разработки аппаратной части HiTech Берлинер активно привлекал студентов. Одним из них оказался Фэн Сюн Сю, который переехал в США из Тайваня и поступил в Карнеги Мелоун 1982 году.

Фэн Сюн Сю получил опыт разработки чипов с нуля на коммерческом проекте на кафедре. Поэтому он предложил улучшить компьютер HiTech. Его идея была в том, чтобы заменить стандартные чипы на специализированные. Это увеличило бы производительность компьютера на порядок. Однако, Берлинер отклонил предложение Фэн Сюн Сю. По его мнению основная игровая сила HiTech заключалась в поиске B*, реализованном программно. Поэтому он стремился как можно скорее закончить аппаратную часть компьютера.

Потратив время на проектирование прототипа нового чипа для HiTech, Фэн Сюн Сю увидел возможность решения Проблемы Компьютерных Шахмат. Так в научных кругах называлась задача разработки программы или компьютера, способного обыграть чемпиона мира по шахматам.

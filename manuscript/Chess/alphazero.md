...
Разработчики объединили все пять нейронных сетей в единую систему AlphaGo. Она работала как ансамбль моделей. При этом поиск по дереву игры выполнялся [**методом Монте-Карло**](https://habr.com/ru/articles/282522/) (Monte Carlo tree search или MCTS).

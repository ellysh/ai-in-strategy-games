...
Мы рассмотрели операцию свёртки. Теперь поговорим об операции подвыборки. Она считается второй фундаментальной концепцией CNN сетей и выполняется после свёртки. Подвыборка решает следующие задачи:

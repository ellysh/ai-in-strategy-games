...
### 3.6.3 Особенности и архитектура AlphaZero
...
### 3.6.4 Поиск по дереву методом Монте-Карло
...
#### 3.6.4.3 Преимущества и недостатки MCTS
...
### 3.6.5 Свёрточная нейронная сеть
...
#### 3.6.5.2 Применение функции активации
...
### 3.6.7 Нейронная сеть AlphaZero

...
I> **Сходимостью** (convergence) называется состояние, в котором процесс обучения достигает стабильного состояния. При этом параметры модели (веса и смещения) устанавливаются в значения, которые не меняются при дальнейшем обучении.
...
### 3.3.3 Агент для игры в шахматы

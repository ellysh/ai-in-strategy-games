...
Классический поиск хорошо работает в одноагентных средах, но не в мультиагентных. Он учитывает действия только самого агента и полностью игнорирует противодействие оппонента. Шахматы являются мультиагентной средой. Агенты, основанные на цели, используют алгоритмы неинформированного поиска. Поэтому ни один из агентов этого класса не способен играть в шахматы.
...
Здесь мы приходим к выводам Клода Шеннона. Его стратегия типа А является ни чем иным, как применением поиска минимакс для игры в шахматы. Учёный не привёл строгих доказательств, что предложенный им алгоритм работает. Но мы можем оценить его с точки зрения теории интеллектуальных агентов.

Может ли агент, построенный на состязательном поиске, играть в шахматы? Такой алгоритм поиска работает в мультиагентной среде. Это означает, что с его помощью в принципе можно искать лучшие ходы в шахматных позициях. Проблема заключается в том, что шахматы — это сложная среда. Поэтому поиск минимакс сможет просчитать максимум четыре-пять ходов вперёд. Для качественной игры этого недостаточно.

Проблему сложности среды могут решить модификации алгоритм минимакс, например альфа-бета отсечение. Эти модификации удаляют из рассмотрения целые поддеревья, опираясь на некоторые эвристики. Такое отсечение позволяет сократить дерево игры более чем в четыре раза. Это приближает глубину просчёта ходов алгоритмом поиска к возможностям профессионального шахматиста.
...
Но несмотря на эти технические трудности, нет никаких принципиальных ограничений для эффективной работы агент.

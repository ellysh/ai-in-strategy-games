...
Вот пример одного из типичных изъянов. Пусть игра представляет собой частично наблюдаемую среду. Машина реализует основанного на полезности агента, который следует некоторому алгоритму состязательного поиска. В таких условиях у машины есть принципиальная проблема с обработкой информации. Её причина в том, что каждый ход агент наблюдает только часть состояния среды. По ходу партии доступная ему информация меняется. Человек способен объединить ранее полученные и новые факты, чтобы собрать полную картину происходящего. Но ни один алгоритм состязательного поиска на это не способен. Это означает, что машина также этого не может. Такой изъян даёт человеку существенное преимущество.

...
Назовём подход разработчиков Stockfish **автоматическим несистематическим поиском** ошибок. Его применяют отделы тестирования фирм по разработке ПО. Такой поиск нужен для тестирования релизов программ. Он выявляет случайные ошибки, которые появились из-за добавления новой функциональности.

Поиск автоматический, потому что его выполняет не человек, а программа. Программа запускает две версии движка, которые играют друг с другом полную партию. Результат каждой партии фиксируется в отчёте. Когда число сыгранных партий достаточно велико, можно говорить о статистических закономерностях и делать какие-то выводы.

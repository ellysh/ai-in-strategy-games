...
1. Разработчик шахматных движков просматривает [историю изменений](https://github.com/official-stockfish/Stockfish/commits/master/) Stockfish. Он составляет список изменений, которые были сделаны после выпуска версии 15. Они исправляют какие-то ошибки и недочёты этой версии.

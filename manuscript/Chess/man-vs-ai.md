...
2. **Система тестирования Fishtest**. Интенсивное автоматическое тестирование выявляет основную массу ошибок в Stockfish. Если в программе остались скрытые ошибки, они либо незначительные, либо их очень сложно воспроизвести.

3. **Информация об исправлениях в последней версии Stockfish ограничена**. У команды экспертов есть только небольшая история изменений после последнего релиза. Найти среди них подходящую для эксплуатации ошибку маловероятно.

Эти особенности характерны не только для Stockfish. Их переняли разработчики коммерческих шахматных движков. Из этого следует, что у команды экспертов очень мало шансов против последней версии любого достаточно сильного шахматного движка.

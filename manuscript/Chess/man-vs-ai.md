...
**Третий шаг** плана — научиться воспроизводить найденные ошибки машины. Успех этого шага зависит от обмена информацией внутри команды экспертов, уровня входящих в неё игроков и ресурсы, которыми они располагают.

Прежде всего специалисты по разработке машин, тестированию и статистике должны объяснить игрокам команды свои находки. Игроки, в свою очередь, должны понять суть найденных ошибок машины. Опираясь на свой опыт, они соотносят изъяны программы и конкретные игровые ситуации. Затем игроки воспроизводят эти игровые ситуации и проверяют, как ведёт в них машина.

Уровень игроков команды экспертов очень важен. Чем он выше, тем разнообразнее ошибки машины они могут воспроизводить и эксплуатировать. Игрок новичок способен понять и воспользоваться грубой ошибкой оппонента. Но только профессионал сможет заметить и извлечь выгоду из незначительного стратегического просчёта противника.

Команда экспертов располагает какими-то ресурсами. Их дефицит может значительно осложнить воспроизведение ошибок машины. Рассмотрим пример. Допустим, что машина отыгрывает только полные партии от начала до конца. Игра достаточно сложная и одна партия занимает много времени. Предположим, что команда экспертов нашла десять потенциальных ошибок в поведении машины. Чтобы воспроизвести и проверить их все, игрокам команды нужно значительное время. Если до начала матча этого времени нет, им придётся выбрать несколько самых перспективных ошибок и работать с только ними.

**Четвёртый шаг** плана — эксплуатировать ошибки машины в матче. На этом шаге важнейший фактор — это уровень игрока, который играет матч. Он определит, как часто будет ошибаться сам игрок и насколько успешно он будет создавать игровые ситуации, в которых воспроизводятся найденные ошибки машины.

Во время матча также важно вмешательство разработчиков машины. Если они вносят исправления, у команды экспертов должен быть достаточный набор ошибок для эксплуатации. Эксперты должны спланировать, в каких именно партиях какую уязвимость машины им выгоднее использовать.

Мы рассмотрели общий план команды экспертов на матч против машины. Следование ему не гарантирует победы, особенно если машина играет на сверхчеловеческом уровне. Хорошая подготовка экспертов только повышает их шансы на успех. При этом остаётся место случайностям, человеческому фактору и ошибкам игрока, который в итоге соревнуется с машиной.

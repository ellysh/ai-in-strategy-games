...
Теперь поговорим о противостоянии человека и машины в произвольной игре. Под человеком будем понимать не одного игрока, а команду экспертов. Её состав может быть разным.

Шансы на победу команды экспертов и машины зависят от ряда факторов и случайностей. Основные факторы следующие:
...
4. Наличие у команды экспертов специальных инструментов.

Эти факторы определяют план команды экспертов на матч с машиной. В зависимости от доступной информации, эксперты могут более или менее качественно выполнять каждый пункт плана. В общем случае чем больше знают или могут узнать о машине эксперты, тем лучше они подготовятся к мачту. Это означает, что доступная информация определяет их шансы на победу.

Общий план команды экспертов на подготовку и матч с машиной выглядит следующим образом:

1. Собрать всю доступную информацию о машине.
...
4. Научиться воспроизводить найденные ошибки и закономерности.

5. Эксплуатировать ошибки в матче против машины.

Рассмотрим подробно каждый пункт плана. Первый шаг — сбор информации о машине. Особенно важны следующие три факта:

1. Какой тип проблемной среды представляет из себя игра? Тип с точки зрения теории интеллектуальных агентов.

2. Какой тип интеллектуального агента реализует машина?

3. Какую стратегию поиска ошибок применяли разработчики?

Ответы на эти вопросы могут сразу указать на потенциальные слабости машины. Для примера допустим, что сложность среды превышает возможности типа агента, который реализует машина. В этом случае у машины будут типичные изъяны, которые мы рассмотрели в разделе 2.2.

Один из типичных изъянов следующий. Пусть игра представляет собой частично наблюдаемую среду. Машина реализует основанного на полезности агента, который следует некоторому алгоритму состязательного поиска. Что это за алгоритм сейчас не важно. В таких условиях у машины есть принципиальная проблема с обработкой информации. Каждый ход игроки имеют часть информации о состоянии среды. По ходу партии доступная информация меняется. Человек способен объединить ранее полученную и текущую информацию, чтобы получить полную картину. Но ни один алгоритм состязательного поиска на это не способен. Это означает, что машина также этого не может. Кроме того, она не учитывает информацию, которая доступна оппоненту. Эти изъяны можно использовать, чтобы получить преимущество.

Кроме трёх основных фактов о машине, следующая информация тоже очень важна:

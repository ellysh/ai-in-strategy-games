...
Мы обсудили три стратегии поиска ошибок в шахматных программах. Возникает вопрос об их универсальности. Можно ли применить эти стратегии к интеллектуальному агенту любого типа для любой игры?

Первая стратегия ручного несистематического поиска очень проста. Для её применения не нужны специальные инструменты и средства. Единственное условие для её применения заключается в том, что человек в принципе способен провести партию с агентом. Например, если игра требует сверхчеловеческой скорости реакции, человек не сможет в ней участвовать. Поэтому в таких условиях стратегию РНП применить нельзя.

Допустим, что интеллектуальный агент и человек способны участвовать в какой-то игре. Они проводят несколько партий. В одной из них могут проявиться слабые стороны агента. Они укажут на недочёты в его управляющей программе. Это и есть результат поиска ошибок с помощью стратегии РНП.

Стратегия ручного несистематического поиска работает для любого типа агентов. Но сложность игры должна быть доступна для человека. Её могут применять для достижения своих целей как разработчики, так и игроки.

Вторая стратегия ручного систематического поиска ошибок сложнее. Главное условие для её применения — возможность следовать повторяемым путём для воспроизведения ошибок. Рассмотрим пример.

Допустим, что игрок ищет ошибки в агенте, который играет в крестики-нолики. Агент может только отыгрывать всю партию от начала и до конца. Нельзя начать партию с произвольного состояния поля. Если игрок хочет применить стратегию РСП, ему нужен специальный инструмент. Этот инструмент расширяет функциональность агента так, чтобы он принимал на вход произвольное состояние игрового поля. В этом состоянии агент выбирает свой следующий ход. Тогда игрок сможет следовать повторяемым путём для воспроизведения ошибки. Это означает, что он может многократно повторять одни и те же тесты. Тестами будут наборы заранее подготовленных состояний игрового поля.
...
Мы пришли к выводу, что стратегия РСП для поиска ошибок в интеллектуальных агентах применима только в определённых условиях. Эти условия касаются интерфейса взаимодействия с агентом, правил игры и её сложности. При этом тип самого агента не важен.

Третья стратегия автоматического систематического поиска самая сложная. Есть два условия для её применения:

1. **Агент не должен существовать в единственном экземпляре**. Только в этом случае можно проводить партии между его разными версиями. Для примера допустим, что агент — это единственный специализированный суперкомпьютер. В этом случае автоматический систематический поиск неприменим. Если же агент — это программа для обычного ПК, стратегия АСП может сработать.

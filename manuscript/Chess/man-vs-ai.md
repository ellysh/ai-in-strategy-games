...
#### 3.8.2.4 Второй сценарий

>>> REWRITE

#### 3.8.2.5 Третий сценарий

### 3.8.3 Общая стратегия игры против машины

>>> REWRITE

// TODO: Изучит алгоритм поиска уязвимостей в программе.

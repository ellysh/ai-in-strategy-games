...
Предлагаю назвать подход разработчиков AlphaZero **автоматическим систематическим поиском** ошибок. На нём строится всё современное машинное обучение.

Поиск систематический, потому что у него есть план. Сравним его с системой Fishtest. Она проверяет изменение в движке Stockfish на возможную регрессию и реальное улучшение игры. Другими словами изменение может привести к каким-то неизвестным новым ошибкам. Система тестирования не знает, в чём заключаются эти ошибки. Она просто проигрывает очень много партий в надежде их обнаружить. Но может быть такое, что ошибка по случайному стечению обстоятельств и не будет обнаружена.

Алгоритм обучения с подкреплением действует более систематично. Начиная с определённого цикла его работы модель уже умеет играть в шахматы. Если играя против самой себя, она допускает грубую ошибку, это приводит к поражению. Алгоритм обучения фиксирует это с помощью отрицательного сигнала. Получив его, модель корректирует соответствующие веса в слоях нейронной сети. В результате модель станет избегать именно этой грубой ошибки.

Конечно я очень упростил описание алгоритма обучения с подкреплением. В результате одной игры модели против самой себя, может быть совершенно непонятно, какой именно ход был грубой ошибкой. Его последствия отсрочены во времени и проявляются только через много ходов. Чтобы отследить эту причинно-следственную связь нужно много циклов работы алгоритма обучения.

Например, в 100000 партий модель совершает одну и ту же грубую ошибку. В ответ на отрицательный сигнал она корректирует веса в своей нейронной сети. Таким образом модель в каком-то смысле ищет, где именно была допущена ошибка. После многократных попыток исправляются именно те веса, которые приводят к неправильному ходу. Теперь представьте, что модель одновременно пытается скорректировать множество своих разных ошибок.

### 3.6.2 Игра против современных шахматных движков

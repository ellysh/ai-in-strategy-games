...
4. Научиться создавать условия для воспроизведения найденных ошибок и закономерностей.
...
Независимо от характера игры есть ряд простых ошибок, которые легко обнаружить:
...
// TODO: Закономерности поведения также важны.

// TODO: Какую стратегию применяли разработчики и использует игрок?

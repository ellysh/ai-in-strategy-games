...
Если придерживаться мнения Клода Шеннона, то ошибка в идеальной игре движка возникает только тогда, когда происходит логическая ошибка в его программе. Это означает, что слабые стороны шахматного движка создают те самые ошибки, которые ищут и устраняют его разработчики.
...
Для игры против шахматного движка нужны знания из разных прикладных областей. Один человек вряд ли сможет владеть всеми этими знаниями на высоком уровне. Поэтому мы рассмотрим игру команды экспертов против шахматного движка. Такой подход кажется справедливым. Потому что шахматный движок — это не один оппонент в виде программы. На самом деле за ним стоит большая команда: разработчики, тестировщики, менеджеры и шахматисты-консультанты проекта.

Состав команды экспертов может быть разным. Он определяет сценарий подготовки команды к матчу. Рассмотрим эти сценарии и начнём с самого простого случая.

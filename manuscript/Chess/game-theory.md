...
В стратегии типа А шахматная программа оценивает каждый возможный ход с помощью эвристической функции. Эта функция присваивает позициям числовые значения в зависимости от того, насколько они выгодны. Такое значение называется **статической оценкой позиции**. Среди всех возможных ходов программа выбирает тот, который ведёт к позиции с наивысшей статической оценкой. Он считается лучшим.

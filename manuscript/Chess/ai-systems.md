...
Шахматные компьютеры конца 1980-х и начала 1990-х приблизились к игре на уровне гроссмейстера. На классическом контроле времени их уровень Эло составлял примерно 2300-2400 пунктов. Этот уровень был выше на 100-200 пунктов в блиц партиях, когда у шахматистов было меньше времени на раздумье. В таких условиях машины показывали [очень хорошие результаты](https://habr.com/ru/post/362643/) в турнирах с людьми.
...
Проблема первого пути была в большой трудоёмкости. Совершенствование алгоритмов и эвристик поиска шло методом проб и ошибок. Некоторые новые эвристики эффективно сокращали дерево поиска. При этом они отсеивали не только плохие ходы, но и очень хорошие. А это было нежелательно. Поэтому каждое изменение алгоритма требовало многократного тестирования.

Для улучшения оценочной функции требовалась консультация профессионального шахматиста. К сожалению, многие команды разработчиков такой поддержки не имели из-за ограниченных ресурсов.
...
В 1989 году руководство IBM приняло решение начать проект по созданию шахматного суперкомпьютера. Компания IBM решила не создавать команду с нуля, а нанять уже опытных разработчиков. Поэтому с самого начала компания нацелилась на команду Deep Thought. Среди шахматных компьютеров того времени это был самый успешный и известный. В течении 1989 и 1990 годов разработчики Deep Though заканчивали обучение в Карнеги Мелоун и переходили на работу в IBM. В команду входили Томас Анансараман, Фэн Сюн Сю и Мюррей Кэмпбелл.

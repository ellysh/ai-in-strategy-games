...
[**Переобучением**](https://wiki.loginom.ru/articles/overtraining.html) (overtraining или overfitting) — одна из проблем обучения модели. Заключается в том, что модель хорошо работает на обучающем наборе данных, но часто ошибается на тестовых и реальных данных.

...
[**Свёрточная нейронная сеть**](https://ru.wikipedia.org/wiki/Свёрточная_нейронная_сеть) (convolutional neural network или CNN) — это подвид многослойной нейронной сети с прямой связью (FNN). Её архитектура использует особенность зрительной коры человека: чередование двух типов слоёв. Эта сеть оптимизирована для одной единственной задачи — распознавание образов.

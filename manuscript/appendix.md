...
Чтобы подготовить обучающий набор данных для нашей классификации, надо объединить виды ирисов 1 и 2 в один класс. Дадим ему номер 1. Для этого скрипт выполняет два действия:

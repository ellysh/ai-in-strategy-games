...
Скрипт `linear-regression.py` из листинга 5-2 демонстрирует обучение модели линейного регрессора на случайно сгенерированном наборе данных. После обучения эта модель прогнозирует стоимость поддержанных автомобилей в зависимости от их пробега. В качестве алгоритма обучения используется метод наименьших квадратов.

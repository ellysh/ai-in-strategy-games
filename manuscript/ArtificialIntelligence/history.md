...
1. Алгоритмы и концепции, разработанные в рамках исследований ИИ, оказались интегрированы в обычные компьютерные системы. Эти достижения ошибочно считаются результатом развития информатики, а не ИИ.

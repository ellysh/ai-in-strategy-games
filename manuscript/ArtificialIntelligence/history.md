...
В 1978 году компания DEC разработала первую коммерческую экспертную систему [XCON](https://en.wikipedia.org/wiki/Xcon). Компания DEC производила компьютера. Система XCON помогала сотрудникам составлять конфигурации компьютеров, согласно требованиям заказчиков. XCON позволяла компании сэкономить до 40 миллионов долларов в год.

Громкий успех системы XCON привел к тому, что корпорации по всему миру начали разработку экспертных систем для внутреннего использования. В эти разработки включились производители компьютерного оборудования. Начали появляться специальные компьютеры под названием [Lsip-машины](https://ru.wikipedia.org/wiki/Лисп-машина). Они предназначались для запуска программ на языке [Lisp](https://ru.wikipedia.org/wiki/Лисп). Этот язык стал основным для разработки экспертных систем.

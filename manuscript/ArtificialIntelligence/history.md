...
Deep learning изучает нейронные сети с многослойной архитектурой. Такие сети называются **глубокими** или **многослойными**.

Благодаря нескольким скрытым слоям сети, алгоритм обучения извлекает признаки разного уровня асбтракции из входных данных. Например, обученная таким образом сеть различает на низком уровне отдельные линии, а на более высоком — цифры и буквы.

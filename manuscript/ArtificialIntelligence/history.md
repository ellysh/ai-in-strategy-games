...
* [**Эвристика**](https://ru.wikipedia.org/wiki/Эвристика) — это дополнительное правило, которое исключает из рассмотрения некоторые ветви дерева поиска. Эвристика без проверки предсказывает, что какая-то ветвь не приведёт к решению. Удаление таких ветвей значительно сокращает время поиска.

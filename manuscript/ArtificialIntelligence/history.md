...
В начале 2000-х годов ситуация изменилась. Интернет становился все более популярен среди рядовых пользователей ПК. Росло число сайтов и онлайн-сервисов, появились первые социальные сети. Пользователи и системы начали генерировать большие объемы данных.

...
Mycin имела базу знаний примерно из 600 правил. Каждое правило описывало некоторый симптом заболевания и **вес доказательства** (weight of evidence) того, что пациент заражен конкретной бактерией. Большее значение веса означало большую вероятность. После получения всех ответов, система подставляла веса для каждого заболевания в формулу. Эта формула вычисляла вероятность, которая указывалась в списке с результатами.
...
Mycin ещё раз подтвердил эффективность экспертных систем в решении практических задач. В то же время эта система обозначила будущие проблемы нового подхода. Разработчики обратили внимание на то, что сбор и занесение в систему экспертных знаний — очень трудоёмкий задача.

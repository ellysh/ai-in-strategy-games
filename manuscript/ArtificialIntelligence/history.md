...
Концепция тродноразрешимых задач означает, что возможности систем ИИ строго ограничены.

### Развитие ИИ 1980 – 1987

#### Экспертные системы

Ранние системы ИИ конца 1950-х годов, такие как General Problem Solver и Advice Taker, претендовали на универсальность. Исследователи заявляли, что их программы способны рассуждать так же, как это делают люди. Таким образом системы потенциальтно могли решить любую задачу.

Главной частью ранних систем ИИ были алгоритмы вывода решения. Общие знания о мире считались второстепенными. Они представляли собой часть кода программы. Системы могли оперировать любыми фактами по одному и тому же алгоритму. Однако, такой подход не сработал для реальных задач из-за комбинаторного взрыва.
...
Экспертная система — это подвид [**системы, основанной на знаниях**](https://en.wikipedia.org/wiki/Knowledge-based_systems) (knowledge-based system или KBS). Отличительная особенность KBS заключается в ей архитектуре. Система состоит из двух частей: **базы знаний** и **механизма вывода**.
...
Рассмотрим первые экспертные системы.

##### Dendral

В 1965 году группа учёных из Стэнфордского университета начала проект системы ИИ, [основанной на знаниях](https://en.wikipedia.org/wiki/Knowledge-based_systems). В группу входили [Эдвард Фейгенбаум](https://ru.wikipedia.org/wiki/Фейгенбаум,_Эдвард_Альберт), Брюс Бьюкенен, [Джошуа Ледерберг](https://ru.wikipedia.org/wiki/Ледерберг,_Джошуа) и [Карл Джерасси](https://ru.wikipedia.org/wiki/Джерасси,_Карл). Система получила название [Dendral](https://ru.wikipedia.org/wiki/Dendral).

Ледерберг занимался исследованиями в области [астробиологии](https://ru.wikipedia.org/wiki/Астробиология). Эта наука изучает жизнь на других планетах. Учёные задался вопросом: сможет ли компьютер помочь ему в изучении незнакомых органических соединений?
...
Для каждого сгенерированного химического соединения вычислялась ожидаемая картина масс-спектра. Она сравнивалась с картиной неизвестной молекулы. Если картины совпадали, система делала вывод, что сгенерированная и неизвестная молекулы совпадают.

Dendral решает задачу, которую в общем можно сформулировать так:
...
##### Производные от Dendral системы

Архитектура системы Dendral доказала свою эффективность. Кроме того, она была достаточно универсальной. Поэтому группа из Стэнфордского университета продолжила разработки экспертных систем для других приклданых областей.
...
Идея экспертных систем распространилась среди исследователей ИИ. В 1978 году Джон Макдермотт из университета Карнеги — Меллона разработал первую коммерческую экспертную систему [XCON](https://en.wikipedia.org/wiki/Xcon). Её заказчиком была компания DEC, производившая компьютеры. Система XCON помогала сотрудникам DEC составлять конфигурации компьютеров, согласно требованиям заказчиков. Экспертная система экономила компании до 40 миллионов долларов в год.

...
Центральной идеей Lisp стала работа со списками: все типы данных представляют собой списки. Для работы с ними Маккарти разработал декларативные конструкции языка.
...
К тому моменту когда интерпретатор языка Lisp был готов, Маккарти потерял интерес проекту Advice Taker. Поэтому его система так и не была реализована.

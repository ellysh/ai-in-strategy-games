...
| [Массачусетский технологический институт](https://ru.wikipedia.org/wiki/Массачусетский_технологический_институт) | Джон Маккарти |
|  | Марвин Мински |
...
|  | | Герберт Саймон |
|  | | |
| Логическое программирование | Задача решается методами формальной логики. | Джон Маккарти |
|  | | |
| Коннекционизм | Задача решается сетью из связанных между собой простых элементов (нейронной сетью). | Уоррен Мак-Каллок |
|  | | Уолтер Питтс |
...
Рассмотрим достижения каждого из направлений ИИ в первые годы науки об ИИ.
...
Исследования Ньюэлла и Саймона заложили основу [**символьного подхода**](https://ru.wikipedia.org/wiki/Символический_искусственный_интеллект). Этот подход предлагает создавать системы ИИ, работа которых основана на манипулировании символами. Этим символы могут быть абстрактными, но должны быть понятны человеку.

Символьный подход оставался доминирующей парадигмой в ИИ с середины 1950-х до конца 1980-х годов.

#### Логическое программирование

Джон Маккарти не был согласен с подходом Ньюэлла и Саймона. Он утверждал, что компьютеру нет необходимости рассуждать также, как это делает человек. Вместо манипулирования абстрактными символами Маккарти предлагал создавать ИИ системы на основе правил [**формальной логики**](https://ru.wikipedia.org/wiki/Формальная_логика) и [**математической**](https://ru.wikipedia.org/wiki/Математическая_логика) логики.
...
На протяжении 1958 года Маккарти работал над системой ИИ [Advice Taker](https://en.wikipedia.org/wiki/Advice_taker). Он описал её принципы работы в статье 1959 года "Программы со здравым смыслом" (["Programs with Common Sense"](http://www-formal.stanford.edu/jmc/mcc59.pdf)).

Система Advice Taker должна была использовать знания для поиска решения задачи. В этом она была похожа на Logic Theorist. Однако, в отличие от неё Advice Taker позволяла добавлять общие знания о мире. Маккарти утверждал, что благодаря этим знаниям система сможет рассуждать с позиции [здравого смысла](https://ru.wikipedia.org/wiki/Здравый_смысл).

Для разработки системы Advice Taker Маккарти спроектировал язык программирования [Lisp](https://ru.wikipedia.org/wiki/Лисп). Он описал этот язык в журнале Communications of the ACM в 1960 году.

В языке Lisp используются многие концепции языка IPL, разработанного для системы Logic Theorist. Ключевой особенностью Lisp стали операции над списками.
...
На заре искусственного интеллекта существовало два принципиально разных направления: символьный подход и [**коннекционизм**](https://ru.wikipedia.org/wiki/Коннекционизм). Иногда выделяют ещё третий подход логическое программирование, который близок к символьному подходу.

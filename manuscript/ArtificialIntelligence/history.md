...
Пол Вербос был первым, кто подробно описал обучение нейронной сети [**методом обратного распространения ошибки**](https://en.wikipedia.org/wiki/Backpropagation) (backpropagation). Это стало темой его диссертации в 1974 году. Но сообщество исследователей не обратило внимание на работу молодого учёного.
...
Новый бум ИИ стал следствием быстрого прогресса и повышенным вниманием СМИ. Этот прогресс стал возможным благодаря удачному стечению ряда событий:
...
4. Доступность фреймворков и библиотек для работы с нейронными сетями. Например, TensorFlow от Google и PyTorch от Facebook. Эти инструменты стали распространяться с открытым исходным кодом. Так разработчики, исследователи и просто энтузиасты получили возможность экспериментировать и внедрять модели ИИ в свои приложения.
...
Эндрю Ын вел курс "Machine Learning" в Стэнфордском университете в 2011 году. На одной из лекций он рассказал о преимуществах использования GPU для обучения нейронных сетей. Видео этих лекции стало доступно через интернет. Так Эндрю Ына идея стала широко известна.

Примерно в это же время группы исследователей и компании производители оборудования уже экспериментировали с GPU и машинным обучением. Скоро В результате коллективных усилий технология использования графических процессоров стала стандартом в области.

Компания Nvidia в 2007 году выпустила платформу [CUDA](https://ru.wikipedia.org/wiki/CUDA). Она позволяла выполнять параллельные вычисления на GPU. Изначально Nvidia рассматривала свой продукт, как средство ускорения работы обычных пользовательских приложений. Но благодаря работе Эндрю Ына и других исследователей, CUDA стала основной программно-аппаратной платформой для моделирования нейронных сетей.

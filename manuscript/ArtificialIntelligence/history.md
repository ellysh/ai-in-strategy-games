...
В конце 1950-х годов ещё не существовало общепринятой терминологии нейронных сетей. Розенблатт вводил новые понятия, которые сегодня уже вышли из употребления. Это приводит к ошибкам при обсуждении идей учёного.

В 1962 году Розенблатт опубликовал книгу "Принципы нейродинамики" (Principles of Neurodynamics). Эта книга представляет собой наиболее достоверный источник информации с оригинальной терминологией автора. В ней Розенблатт рассматривает различные архитектуры перцептронов, в том числе и многослойные. Также в книге доказана [теорему сходимости перцептрона](https://ru.wikipedia.org/wiki/Теорема_сходимости_перцептрона). Согласно теореме, перцептрон можно обучить за конечное число шагов. После такого обучения он сможет решить поставленную задачу.
...
Студенты МТИ выбирали для себя какой-то "микромир" и разрабатывали для него ИИ систему в качестве дипломной работы. Наибольшей популярностью у студентов пользовался [мир блоков](https://en.wikipedia.org/wiki/Blocks_world). Он представлял собой плоскую поверхность, на которой лежали блоки различных цветов и форм.

Самым известным проектом для мира блоков была программа [SHRDLU](https://ru.wikipedia.org/wiki/SHRDLU). Её разработал [Терри Виноград](https://ru.wikipedia.org/wiki/Виноград,_Терри) в 1970 году.

Программа получала от пользователя команды на английском языке. Исполнение команд приводило к перемещению объектов в виртуальном пространстве мира блоков. Программа запоминала все выполненные действия и могла отвечать на вопросы о текущем состоянии объектов. Также она комментировала выполнима или нет запрошенная команда. Если SHRDLU не понимала команды пользователя, она задавала уточняющие вопросы.

...
Иллюстрация 2-1 демонстрирует функцию активации бинарного порогового нейрона. На оси Y отображаются значения функции активации f(x). На оси X — значения суммы входных сигналов x. Когда эта сумма достигает значения θ, нейрон переходит в возбуждённое состояние. Его выходной сигнал становится равен единице.

{caption: "Иллюстрация 2-1. Функция активации бинарного порогового нейрона", height: "30%"}
...
В конце 1950-х годов Розенблатт представил результат своей работы в виде модели того, как мозг человека воспринимает информацию. Эта модель получила название [**перцептрон**](https://ru.wikipedia.org/wiki/Перцептрон). Позднее она стала известна как [**binary classifier**](https://www.youtube.com/watch?v=mI6jTc-8sUY) (бинарный классификатор).

Перцептрон представляет собой искусственную нейронную сеть. Иллюстрация 2-1 демонстрирует её архитектурой.

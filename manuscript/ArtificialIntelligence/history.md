...
##### 2.1.1.1.3 Первая реализация

Первая специализированная нейронная сеть была реализована в виде специального компьютера. Его сконструировали аспиранты математики [Марвин Минский](https://ru.wikipedia.org/wiki/Минский,_Марвин_Ли) и Дином Эдмондсом в 1951 году. Компьютер использовал электровакуумные лампы в качестве рабочих элементов. Он получил название [Snarc](https://en.wikipedia.org/wiki/Stochastic_neural_analog_reinforcement_calculator). Snarc моделировал сеть из 40 нейронов. Минский и Эдмондс пытались научить эту сеть проходить лабиринт. Для простоты соединения между нейронами и представляли собой этот лабиринт.

...
Так или иначе на сегодняшний день несколько интеллектуальных систем успешно прошли тест Тьюринга. Однако, назвать их разумными нельзя. Поэтому современные исследователи отказались как от самого теста в качестве инструмента тестирования, так и от идеи мыслящей как человек машины.

##### 2.1.1.2.2 Статья "Умная машинерия"

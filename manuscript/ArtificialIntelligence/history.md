...
Центральной идеей Lisp стала работа с выражениями. В отличие от большинства других языков того времени Lisp не делал различий между выражениями и инструкциями: и то и другое записывается в виде выражений. Эти выражения представляются в виде списков.

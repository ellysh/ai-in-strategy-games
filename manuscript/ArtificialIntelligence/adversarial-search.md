...
* Если в каком-то узле значение α оказывается больше или равно β, все его непроверенные дочерние узлы отсекаются.
...
// TODO: Объяснить каждое отсечение.

Алгоритм альфа-бета находит такое же решение, как и алгоритм минимакс. Оно отмечено чёрной стрелкой на иллюстрации 2-13:

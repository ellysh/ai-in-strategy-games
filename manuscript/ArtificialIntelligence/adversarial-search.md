...
Мы познакомились с алгоритмами классического поиска. Благодаря им, агент выбирает правильные действия в одноагентной среде. Эти действия приводят к решению поставленной задачи.

Классический поиск не работает в условиях, когда два и более агентов ищут решение в одной и той же среде. Проблема заключается в том, что действия каждого агента меняют состояние среды. Классический поиск учитывает действия только одного агента.

Если агенты конкурируют друг с другом, их действия могут мешать оппоненту достигнуть цели. Это ещё более усложняет решение задачи. Поиск в таких условиях называется **состязательным** или **поиском в условиях противодействия** (adversarial search). Его применяют агенты, основанные на полезности.

Рассмотрим состязательный поиск подробнее.
...
Мы рассмотрим два алгоритма состязательного поиска. Их демонстрирует таблица 2-15.

{caption: "Таблица 2-15. Алгоритмы состязательного поиска", width: "100%"}
...
Самый известный алгоритм состязательного поиска называется [**минимакс**](https://ru.wikipedia.org/wiki/Минимакс). Этот алгоритм основан на [теореме о минимаксе](https://fr-m-wikipedia-org.translate.goog/wiki/Théorème_du_minimax_de_von_Neumann?_x_tr_sl=auto&_x_tr_tl=en&_x_tr_hl=en&_x_tr_pto=wapp). Она была разработана в рамках теории игр и доказана в 1928 году Джоном фон Нейманом.

Поиск минимакс проходит узлы дерева в том же порядке, что и поиск в глубину. Во время прохода алгоритм оценивает потенциальные выигрыши каждого игрока в посещённых узлах. Эти выигрыши называются **минимаксными значениями**.
...
Рассмотрим пример работы алгоритма минимакс. Иллюстрация 2-16 демонстрирует дерево поиска и порядок обхода его узлов.
...
Таблица 2-16 демонстрирует шаги алгоритма минимакс для дерева поиска с иллюстрации 2-16. Для каждого шага указан посещаемый узел и его новое минимаксное значение.

{caption: "Таблица 2-16. Шаги алгоритма минимакс", width: "70%"}
...
Таблица 2-17 демонстрирует шаги алгоритма альфа-бета для дерева поиска с иллюстрации 2-17. Для каждого шага указан посещаемый узел, его новое минимаксное значение, а также текущие значения α и β.

{caption: "Таблица 2-17. Шаги алгоритма минимакс", width: "90%"}
...
Рассмотрим шаги алгоритма в таблице 2-17. Первые 11 шагов альфа-бета отсечения и минимакса полностью совпадают. Алгоритмы присваивают одни и те же минимаксные значения узлам B, D, E, H, I, J.

Первое различие в таблицах 2-16 и 2-17 происходит на шаге 12. На этом шаге алгоритм минимакс посещает узел K. Альфа-бета отсечение пропускает узел K без проверки. Это происходит потому, что на 11 шаге для узла E выполнилось условие α > β (7 > 6). При выполнении этого условия все непосещённые дочерние узлы E отсекаются.

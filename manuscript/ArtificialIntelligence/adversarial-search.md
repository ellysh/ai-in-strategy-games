...
Таблица 2-20 демонстрирует шаги алгоритма для дерева игры на иллюстрации 2-17. Для каждого шага указаны: посещаемый узел, его новое минимаксное значение, текущие значения α и β.
...
Рассмотрим шаги алгоритма в таблице 2-20. Первые 11 шагов альфа-бета отсечения и минимакса полностью совпадают. Оба алгоритма присваивают одни и те же минимаксные значения узлам B, D, E, H, I, J.

Первое различие в таблицах 2-19 и 2-20 происходит на шаге 12. На этом шаге алгоритм минимакс посещает узел K. Альфа-бета отсечение пропускает узел K без проверки. Это происходит потому, что на 11 шаге в узле E выполнилось условие α > β (7 > 6). Из-за этого все непосещённые дочерние узлы E отсекаются.

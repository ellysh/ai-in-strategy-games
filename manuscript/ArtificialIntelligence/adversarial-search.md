...
Таблица 2-18 демонстрирует шаги алгоритма минимакс для дерева игры на иллюстрации 2-16. При посещении каждого узла алгоритм вычисляет для него новое минимаксное значение. Оно так же приводится в таблице.
...
Рассмотрим альфа-бета отсечение на примере игры с иллюстрации 2-16. Работу алгоритма демонстрирует иллюстрация 2-17.

{caption: "Иллюстрация 2-17. Поиск по алгоритму альфа-бета отсечения"}
![Алгоритм альфа-бета](images/ArtificialIntelligence/alpha-beta-pruning-tree.png)

Иллюстрация 2-17 показывает, что алгоритм отсекает узлы K, G, N, O. Они никак не влияют на конечное решение.

Таблица 2-19 демонстрирует шаги алгоритма для дерева игры на иллюстрации 2-17. Для каждого шага указаны: посещаемый узел, его новое минимаксное значение, текущие значения α и β.

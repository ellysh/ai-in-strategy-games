...
1. Поиск [методом проб и ошибок](https://en.wikipedia.org/wiki/Trial_and_error).
...
Второй вопрос: что означает поиск методом проб и ошибок в машинном обучении?

// TODO: Закончить этот раздел

##### Алгоритм обучения

Рассмотрим алгоритм обучения с подкреплением на примере.

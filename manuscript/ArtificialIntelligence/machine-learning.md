...
Агент снова многократно играет с оппонентом, используя стратегии второго поколения. Так отбираются наиболее успешные из них. Этот процесс повторяется снова и снова. Алгоритм обучения завершается, когда находит стратегию с вероятностью выигрыша 90%, либо достигает максимально допустимого числа поколений. <TODO: проверить другие методы policy-based подхода>
...
Кроме Q-learning сегодня популярны следующие основанные на полезности (policy-based) методы:

...
Применим обучение с подкреплением для нашей задачи. Агент будет многократно играть с оппонентом. То каким образом агент получит свою финальную стратегию, будет зависеть от выбранного нами подхода.

Предположим, что мы выбрали подход, основанный на стратегии (policy-based).
...
Алгоритмы обучения с учителем и без учителя создают модели, которые работают в эпизодических средах. Обучение происходит на несвязанных между собой примерах входных данных. Готовые модели обрабатывают такие же несвязанные новые данные. В этом случае прошлые решения агента никак не влияют на его последующие решения. Поэтому агент не отслеживает долгосрочный результат своих действий.

Алгоритмы обучения с учителем и без не могут создать агента, который действует в последовательной среде. Для этого нужна другая парадигма. Именно эту задачу решает обучение с подкреплением.

...
При обучении модели могут возникнуть разные проблемы. Вот несколько из них:
...
Чтобы продемонстрировать работу модели, обратимся к графику на иллюстрации 2-19. Предположим, что модель получила входные данные: ширина и длина чашелистника неизвестного ириса. Отложим на горизонтальной и вертикальной оси значения этих признаков. Если точка оказалась выше границы классов, проверяемый ирис относится к виду Iris setosa. В противном случае, этот ирис относится к другому виду.

...
Python скрипт для классификации ирисов Фишера приводится в приложении 4.1.1 и на [Github](https://github.com/ellysh/ai-in-strategy-games/blob/master/manuscript/resources/code/ArtificialIntelligence/linear-classifier.py).
...
Python скрипт для линейной регрессии цен на автомобили приводится в приложении 4.1.2 и на [Github](https://github.com/ellysh/ai-in-strategy-games/blob/master/manuscript/resources/code/ArtificialIntelligence/linear-regression.py).
...
Python скрипт для кластеризации методом k-средних  случайно сгенерированного набора данных приведён в приложении 4.1.3 и на [Github](https://github.com/ellysh/ai-in-strategy-games/blob/master/manuscript/resources/code/ArtificialIntelligence/k-mean-clustering.py).
...
Чтобы решить проблему многорукого бандита,  нужно много вычислений. Окончательного ответа для неё пока не найдено. Есть только ряд приблизительных решений, которые дают не наилучший, но приемлемый результат.

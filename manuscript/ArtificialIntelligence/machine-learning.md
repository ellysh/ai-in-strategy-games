...
Рассмотрим подробнее первые две задачи и примеры к ним.
...
Остаётся открытым один вопрос: как именно алгоритм обучения подбирает веса w~1~ и w~2~ в нашем примере с ирисами? Для моделей линейных классификаторов часто применятся [**стохастический градиентный спуск**](https://ru.wikipedia.org/wiki/Стохастический_градиентный_спуск). Мы рассмотрим его позже.

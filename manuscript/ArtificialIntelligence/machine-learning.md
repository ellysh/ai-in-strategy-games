...
{caption: "Иллюстрация 2-18. Компоненты машинного обучения", height: "50%", width: "100%"}
...
Таблица 2-21 демонстрирует парадигмы обучения и решаемые с их помощью задачи.

...
| основанный на | Пропозициональная | Последовательная |
...
Все рефлексные агенты не способны работать в неизвестной среде. Агенты, основанные на поиске, могут справиться с некоторыми простыми неизвестными средами. Однако, остаётся большой набор задач, которые не может решить ни один из рассмотренных типов агентов.

**Обучающиеся агенты** решают проблему работы в неизвестной среде любой сложности. Отличительная особенность таких агентов — это способность к **обучению**. Обучением называется автоматическое улучшение агентом своих показателей производительности. Агент обучается на своём собственном опыте или на данных.

Обучающиеся агенты могут иметь первоначальные правила для работы в проблемной среде. Эти правила задаются разработчиком агента. В ходе своей работы агент улучшает эти правила и добивается лучших показателей производительности.

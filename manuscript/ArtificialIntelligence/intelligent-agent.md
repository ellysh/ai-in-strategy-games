...
Мы рассмотрим эти подходы подробнее в следующем разделе.
...
Предположим, что агент выбирает свои действия на основе таблицы правил. В этом случае он не сможет действовать в неизвестной среде. Перед началом работы, агент должен узнать о правилах изменения среды. Другими словами, он должен заполнить свою таблицу правил. Такой процесс называется **обучением**. Способный к обучению агент называется **обучающимся**.

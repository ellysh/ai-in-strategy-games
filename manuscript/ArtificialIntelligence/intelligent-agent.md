...
Агент, основанный на полезности, успешно действует в частично наблюдаемых средах. Даже если часть среды постоянно остаётся скрытой от агента, он выберет наилучшее возможное действие в текущей ситуации. В отличие от рефлексного агента, он не путает состояния среды. Это предотвращает заведомо неправильные действия.

...
Датчики агента могут давать полную информацию о состоянии среды в каждый момент времени. В таком случае проблемная среда называется **полностью наблюдаемой**. Пример такой среды — шахматная партия. Агент может наблюдать расположение всех фигур в любой момент.

В **частично наблюдаемой** среде агент не может получить полную информацию о происходящем через свои датчики. Например, в [бридже](https://ru.wikipedia.org/wiki/Бридж) агент знает только свои карты, но не карты других игроков.
...
В терминологии теории игр в стохастической среде присутствует внешняя неопределённость. Поэтому игра с несовершенной информацией является стохастической средой.

#### 2.2.3.3 Акты восприятия агента

Датчики агента могут воспринимать окружающую среду двумя способами. В первом случае агент получает состояния среды одно за другим. Каждое следующее состояния не зависит от предыдущего и совершённых ранее действий агента. В этом случае среда называется **эпизодической**.
...
Перед тем, как начать действовать, агент может знать последствие любого своего действия. В этом случае говорят, что среда **известна** агенту. Если агент не знает результаты своих возможных действий, среда называется **неизвестной**.

Вот пример. Рассмотрим агента для игры в шахматы. Если он знает правила игры, ценность и ходы фигур, то среда будет для него известной. Если агент не знает правил, ему сначала придётся их изучить. В этом случае среда будет для него неизвестной.
...
В сложной среде у агента много вариантов действий с разными результатами. Это связано с числом возможных состояний среды. Когда состояний много, есть много способов повлиять на среду. Каждое из воздействий приведёт к разному результату. Следовательно, агент должен различать эти воздействия.

...
Программу обучающегося агента автоматически создаёт **механизмом обучения**. Существует несколько подходов к реализации этого механизма. Их разрабатывает направление ИИ под названием [**машинное обучение**](https://en.wikipedia.org/wiki/Machine_learning).
...
Алгоритм обучения принимает на вход данные. В этих данных он находит закономерности. Далее алгоритм строит обучаемую модель. Она учитывает все найденные закономерности.

Существует три класса алгоритмов обучения:

* **Обучение с учителем**
* **Обучение без учителя**
* **Обучение с подкреплением**

Мы рассмотрим эти классы алгоритмов далее в разделе "Машинное обучение."

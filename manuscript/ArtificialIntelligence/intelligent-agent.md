...
Для решения задачи агенту нужно какое-то время. В течении этого времени он наблюдает окружающую среду и действует в ней. Этот процесс описывают два понятия: восприятие и последовательность актов восприятия.
...
Мы рассмотрели понятия, которые нужны для полного определения рационального агента. Рассел и Норвиг формулируют это определение так:
...
Рефлексные агенты не способны работать в неизвестной среде. Агенты, основанные на поиске, могут справиться с некоторыми простыми неизвестными средами. Однако, остаётся большой набор задач, которые не может решить ни один из рассмотренных типов агентов.

**Обучающиеся агенты** решают проблему работы в неизвестной среде любой сложности. Их отличительная особенность — способность к **обучению**. Обучением называется автоматическое улучшение агентом своих показателей производительности. Агент обучается на своём собственном опыте или на переданных ему данных.

Обучающийся агент может иметь первоначальные правила для работы в проблемной среде. Они задаются разработчиком агента. Совершая действия и анализируя их последствия, агент улучшает эти правила и добивается лучших показателей производительности.

Если разработчик не задал первоначальные правила работы, обучающийся агент узнаёт их самостоятельно. В этом случае агент начинает со случайных действий и проверяет, к каким состояниям среды они приводят. Постепенно агент начинает действовать более интеллектуально. Рано или поздно он решает поставленную задачу.
...
Агент, построенный современными технологиями машинного обучения, способен действовать в самых сложных мультиагентных неизвестных средах. Поэтому машинное обучение считается сегодня наиболее перспективным направлением для исследований.
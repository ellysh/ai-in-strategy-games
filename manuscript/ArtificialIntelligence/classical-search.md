...
|  | | | | |
| Поиск по критерию стоимости (UCS) | O(b<sup>1+C/ε</sup>) | O(b<sup>1+C/ε</sup>) | Да, если стоимости всех шагов строго положительны | Да, если стоимости всех шагов строго положительны |
|  | | | | |
...
|  | | | | |
| Дву- | O(b<sup>d/2</sup>) | O(b<sup>d/2</sup>) | Да | Да, если |
...
В общем случае алгоритмы неинформированного поиска работают и для явных, и для неявных графов. Мы рассмотрим только случай явных графов. Так будет проще проиллюстрировать принцип работы алгоритмов.

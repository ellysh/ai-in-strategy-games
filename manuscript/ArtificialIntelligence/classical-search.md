...
{caption: "Иллюстрация 2-3. Функции оценки сложности алгоритма", height: "30%"}
...
{caption: "Иллюстрация 2-4. Порядок обхода узлов при поиске в ширину", height: "25%"}
...
{caption: "Иллюстрация 2-5. Порядок обхода узлов при поиске по критерию стоимости", height: "25%"}
...
{caption: "Иллюстрация 2-6. Порядок обхода узлов при поиске в глубину", height: "25%"}
...
{caption: "Иллюстрация 2-7. Порядок обхода узлов при поиске с ограничением глубины"}
...
{caption: "Иллюстрация 2-8. Порядок обхода узлов при поиске в глубину с итеративным углублением"}
![Поиск в глубину с итеративным углублением](images/ArtificialIntelligence/iddfs-tree.png)

Поиск выполняется как последовательность итераций. Таблица 2-10 демонстрирует итерации для дерева поиска на иллюстрации 2-8.
...
{caption: "Иллюстрация 2-9. Порядок обхода узлов при двунаправленном поиске"}
...
Алгоритм останавливается на 6-ой итерации, когда прямой и обратный поиск встречаются в узле E. Далее алгоритм объединяет оба результата в один: D -> B -> E -> F -> J. Этот путь отмечен на иллюстрации 2-9 чёрной стрелкой.
...
{caption: "Иллюстрация 2-10. Порядок обхода узлов при жадном поиске по первому наилучшему совпадению"}
...
Он отмечен чёрной стрелкой на иллюстрации 2-10.
...
{caption: "Иллюстрация 2-11. Порядок обхода узлов при поиске А\*"}
...
Этот путь отмечен чёрной стрелкой на иллюстрации 2-11.

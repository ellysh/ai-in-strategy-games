...
Алгоритмы неинформированного применяют агенты, основанные на цели. Такие алгоритмы различаются между собой только порядком обхода вершин графа пространства состояний.

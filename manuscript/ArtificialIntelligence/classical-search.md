...
Сначала познакомимся с более простым классом алгоритмов, которые известны как **классический поиск**. Их применяют основанные на цели агенты, работающие в одноагентных средах.

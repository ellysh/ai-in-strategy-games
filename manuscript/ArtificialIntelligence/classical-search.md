...
Рассмотрим современные методы символьного подхода в ИИ, которые основаны на алгоритмах поиска. Эти методы используют интеллектуальные агенты двух типов:

* Агенты, основанные на цели.
* Агенты, основанные на производительности.

Сначала познакомимся с более простым классом алгоритмов, которые известны как **классический поиск**. Их применяют оба типа агентов, когда они работают в одноагентных средах.
...
{caption: "Иллюстрация 2-3. Функции оценки сложности алгоритма"}
...
|  | | | | |
| Дву- | O(b^d/2^) | O(b^d/2^) | Да | Да, если стоимость всех шагов одинакова |
| направленный поиск | | | | |
...
{caption: "Иллюстрация 2-4. Порядок обхода узлов при поиске в ширину"}
...
{caption: "Иллюстрация 2-5. Порядок обхода узлов при поиске по критерию стоимости"}
...
{caption: "Иллюстрация 2-6. Порядок обхода узлов при поиске в глубину"}
...
{caption: "Таблица 2-10. Итерации поиска", width: "100%"}
...
{caption: "Таблица 2-11. Итерации двунаправленного поиска", width: "100%"}
...
{caption: "Таблица 2-14. Шаги поиска A\*", width: "100%"}

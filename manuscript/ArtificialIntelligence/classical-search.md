...
Во время двунаправленного поиска чередуются итерации прямого и обратного поиска. Таблица 2-14 демонстрирует эти итерации.
...
Таблица 2-15 демонстрирует алгоритмы информированного поиска, которые применяются на практике чаще всего.
...
Таблица 2-16 демонстрирует все значения эвристической функции.
...
На первом шаге алгоритм выбирает между узлами B и C. Согласно эвристической функции из таблицы 2-16, узел C находится ближе к целевому узлу, чем B. Расстояние C-H равно 25, а B-H 35.

Далее алгоритм выбирает между узлами F и G. Расстояние F-H равно 10, согласно таблице 2-16. Расстояние G-H равно 15. Это значит, что узел F ближе к узлу H. Поэтому алгоритм выберет путь через узел F.
...
Пусть значения эвристической функции будут такими же, как в таблице 2-16. В этом случае алгоритм поиска выполнит шаги из таблицы 2-17.

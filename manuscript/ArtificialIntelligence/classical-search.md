...
Таблица 2-10 демонстрирует самые распространённые алгоритмы неинформированного поиска.
...
Жадный поиск по первому наилучшему совпадению ориентируется только на значения эвристической функции из таблицы 2-14. Поэтому алгоритм найдёт следующий путь:
...
Пусть значения эвристической функции будут такими же, как в таблице 2-14. В этом случае алгоритм поиска выполнит шаги из таблицы 2-15.

...
> Игра представляет собой попросту совокупность описывающих её правил.
...
Многие типы социального взаимодействия и конфликты можно свести к упрощённой модели. Например, это может быть спорт, война или рыночные отношения. Модель представляет собой **абстрактную стратегическую игру**. При этом она учитывает самые важные аспекты исходного взаимодействия.
...
|  | |
| Информированность участников об игровых | [**Совершенная информация**](https://ru.wikipedia.org/wiki/Игра_с_совершенной_информацией) |
| событиях | **Несовершенная информация** |
|  | |
...
|  | |
| Взаимодействие | [**Кооперативная игра**](https://ru.wikipedia.org/wiki/Кооперативная_теория_игр) |
| участников | [**Некооперативная игра**](https://ru.wikipedia.org/wiki/Некооперативная_теория_игр) |
|  | |
| Допустимые ходы | [**Беспристрастная игра**](https://ru.wikipedia.org/wiki/Беспристрастная_игра) |
| участников | **Пристрастная игра** |
|  | |
| Количество возможных | **Дискретная игра** |
| стратегий | **Непрерывная игра** |

К сожалению, общепринятой классификации игр на сегодня нет. Русскоязычная и англоязычная литература следуют разным подходам. Кроме того, несколько авторитетных специалистов по экономике и теории игр предлагают свои варианты классификации.
...
Концепцию общего знания лучше всего демонстрирует классическая [**задача о чумазых детях**](https://ru.wikipedia.org/wiki/Задача_о_чумазых_детях). Её формулировка выглядит так:
...
Продолжая такие рассуждения, доказываем, что все N испачканных детей сделают шаг вперёд на N-м счёте. Дети могут понять состояние своего лица благодаря общему знанию. Оно появилось из информации от воспитателя.
...
Теория игр различает два типа неопределённости:
...
#### 1.2.2.6 Повторяемость

**Однократными** называются игры, которые проводятся только один раз. Также они могут проводиться несколько раз, но каждый желающий участвует в игре только единожды.

В однократных играх участники склонны применять агрессивные стратегии, поскольку не опасаются ответных действий в последующих партиях. Например, такие как блеф и обман оппонентов.

Также в однократных играх участники, как правило, владеют неполной информацией. У них нет возможности узнать друг друга по предыдущим играм.

Если игра проводится несколько раз с одним и тем же составом участников, она называется **многократной**. В таких играх участники учитывают действия друг друга из прошлых партий. По этой причине агрессивные стратегии  работают хуже. Например, обман может сработать в первой партии, но во второй оппоненты его ожидают и подготовятся лучше.

В многократных играх участники лучше знают друг друга. Поэтому часто это игры с полной информацией.

#### 1.2.2.7 Количество ходов

Игра называется **одноходовой**, если каждый участник делает только один ход. В этом случае стратегия каждого игрока сводится к однократному действию. Вариантов такого действия может быть несколько. Пример — игра в кости. Каждый игрок бросает кубики один раз. Результаты бросков всех игроков определяют победителя.

Если игра состоит из последовательных ходов, она называется **многоходовой** или **позиционной**. Её участники делают ходы по порядку друг за другом или одновременно. Пример такой игры — крестики нолики. Участники которой делают ходы, пока один из них не побеждает или не наступает ничья.

В многоходовых играх стратегия участников — это подробный план действий. Он описывает возможные ходы оппонентов и игровые события, а также ответные действия на них.

#### 1.2.2.8 Правила игры

В настольных играх и спортивных соревнованиях правила строго определены. Нарушитель либо получает штраф, либо исключается из игры.

В социальных взаимодействиях правила нестрогие. Участники сами определяют порядок своих действий и решают, какие из них допустимы. Эти правила формируются под влиянием воспитания, законов, общепризнанных ценностей.

Когда правила в игре не фиксированы, участники склонны ими манипулировать. Обычно это происходит до начала игры. Каждый участник стремится изменить правила так, чтобы увеличить свой выигрыш. Из-за этих манипуляций игра делится на два этапа. На первом этапе игроки предпринимают действия, чтобы повлиять на правила. На втором этапе начинается сама игра по установленным правилам.

**Стратегическим ходом** называется действие, которое позволяет изменить правила игры. Стратегические ходы бывают трёх типов:

* Обязательство
* Угроза
* Обещание

**Обязательство** — это заявление одного из участников о том, какой ход он намерен сделать независимо от действий других игроков. Обязательство является **безусловным** стратегическим ходом. Это значит, что на него не могут повлиять чьи-либо действия.

По сути обязательство меняет порядок ходов в игре. Если участник A дал обязательство сделать X, он тем самым уже делает свой ход. Когда начинается игра, участник B вынужден отвечать на ход A.

Следующие два стратегических хода: угроза и обещание. Они оба являются **условными**. При таком ходе участник A заявляет: "если вы сделаете X, я сделаю Y". Это заявление имеет смысл, только если участник A ходит не первым. Своим сообщением он влияет на решения тех, кто будет ходить до него.

Условный стратегический ход преследует одну из двух целей:

* Сдерживание
* Принуждение

**Сдерживанием** называется попытка одного игрока помешать другому что-то сделать. Другими словами, участник A удерживает участника B от выполнения какого-то действия.

**Принуждение** — это попытка одного игрока склонить другого к какому-то действию. То есть участник A принуждает участника B сделать что-то.

Допустим, что игрок B собирается совершить действие X. Игроку A об этом известно. Тогда A заявляет B: "если ты сделаешь X, я причиню тебе вред". Такое заявление называется **угрозой**. С другой стороны, A может заявить обратное: "если ты сделаешь X, я дам тебе вознаграждение". Такое заявление называется **обещанием**.

Угроза и обещание могут преследовать одну и ту же цель. Оба хода работают и для сдерживания, и для принуждения.

Чтобы стратегический ход игрока достиг цели, надо обеспечить его **достоверность**. Рассмотрим пример. Участник A обещает вознаграждение участнику B за действие X. Допустим, что игрок B знает: A выгодно отказаться от своего заявления, когда начнётся игра. В этом случае заявление A никак не повлияет на ход игры. Для B нет смысла совершать действие X, поскольку обещанного ему вознаграждения не будет. Чтобы обещание стало достоверным, его выполнение должно приносить выгоду не только B, но и A.

Проблема достоверности актуальна и для угрозы. Если игроку A выгодно выполнить свою угрозу независимо от действий B, то B нет смысла подчиняться. Только если выполнение угрозы нанесёт вред самому участнику A, B поверит в её достоверность. Это гарантирует, что A не выполнит угрозу безусловно.

Как обеспечить достоверность условного стратегического хода в общем случае? Для этого обещанное игроком действие должно приносить ему выгоду или наносить вред одновременно с игроком, которому это обещание даётся. Другими словами, выполнение угрозы приносит взаимный вред, а выполнение обещания — взаимную выгоду. Только тогда заявление игрока достоверно.

#### 1.2.2.9 Взаимодействия участников

Социальные взаимодействия сводятся к абстрактным стратегическим играм. В них интересы участников частично конфликтуют и частично совпадают. Такое смешение интересов подталкивает игроков договариваться о своих действиях. Если удаётся достичь соглашения, каждый получает максимальный выигрыш.

Проблема договорённостей в том, что их выполнение сложно отследить. Договорённость заключается на одном этапе игры, а участники  действуют на другом. Если игра параллельная, то игроки узнают действия друг друга только после их совершения.

Предположим, что нарушение договорённости увеличивает выигрыш игрока. В этом случае он склонен её нарушить. Если это справедливо для каждого участника, договорённость не имеет силы. Каждый предпочтёт не следовать ей.

Игра называется **некооперативной**, когда нет внешних стимулов для выполнения договорённостей. Примеры таких стимулов: контракт, закон, третья сторона, стратегические ходы.
...
#### 1.2.2.10 Допустимые ходы участников

В некоторых играх участникам разрешается делать одинаковые ходы. Например, в ним каждый игрок берёт произвольное число предметов из каждой кучки. Поэтому оба участника могут следовать одной и той же стратегии. Такие игры называются **беспристрастными**.

В **пристрастной игре** каждый игрок имеет свой набор возможных ходов. Например, в шахматах игрок двигает только фигуры своего цвета.

#### 1.2.2.11 Количество возможных стратегий

В **дискретной игре** у каждого участника есть конечное число чистых стратегий. [**Чистая стратегия**](https://ru.wikipedia.org/wiki/Стратегия_(теория_игр)#Типы_стратегий) однозначно определяет действия игрока во всех возможных игровых ситуациях. Если игрок выбирает одну из нескольких чистых стратегий случайным образом, это называется **смешанной стратегией**. Обратите внимание, что в этом случае выбранная чистая стратегия не меняется до окончания партии.

К дискретным играм относятся настольные игры. Например, шахматы, шашки, покер. В них у каждого участника есть конечное число стратегий. Это число может быть очень большим, как например в шахматах, но оно конечно.

В **непрерывной игре** у участников есть бесконечное число чистых стратегий. В частном случае стратегия представляет собой число, которое игрок выбирает из непрерывного диапазона.

Пример дискретной игры — назначение цены на аналогичный товар двумя конкурирующими производителями. Цена назначается с точностью до копейки. В таком случае предполагается, что цена — это непрерывное значение. Стратегия каждого игрока соответствует назначенной им цене. Таким образом каждый игрок имеет **непрерывную стратегию**.

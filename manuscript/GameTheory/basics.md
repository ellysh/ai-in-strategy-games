...
Теория игр рассматривает только **стратегические игры**. От обычных игр они отличаются тремя особенностями:
...
В игре её участники должны делать **ходы**. Ход представляет собой возможность выбора между несколькими вариантами действий. Ход представляет собой некоторый компонент игры. Когда участник совершает определённое действие в конкретной ситуации, это называется **выбором**. Игра состоит из последовательности ходов, а партия — из последовательности выборов.

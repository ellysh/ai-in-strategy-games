...
Рассмотрим основные концепции теории игр. Они помогут нам анализировать стратегические игры. Так мы сможем сравнить, как действуют в них люди и как это делает ИИ.
...
Джон фон Нейман определяет предмет своего изучения более конкретно:
...
Теория игр рассматривает только стратегические игры. Почему? Это следует из задач, которые теория ставит перед собой. Главная из них — объяснить различные события и их причины.
...
Абстрактная стратегическая игра поддаётся изучению с помощью математического аппарата теории игр. Этот аппарат позволяет найти некоторое решение. Если модель и математические выкладки были верны, решение окажется применимо к изначальному взаимодействию. Анализ модели подробно объяснит это взаимодействие.
...
Вернёмся к терминологии теории. **Партией** называется каждый случай разыгрывания игры определённым способом от начала до конца. Игра и партия означают не одно и то же.
...
I> Современная литература по теории игр редко различает понятия игра-партия и ход-выбор.

Каждый участник игры следует некоторой **стратегии**. Этот термин означает подробный план действий. План включает все возможные события и ответные действия на них. В случае сложной и важной игры стратегия записывается формально в виде документа. Пример такого документа — контракт между работником и работодателем. В простых играх, участники могут составлять стратегию на ходу.
...
Общепринятой классификации игр на сегодняшний день ещё нет. Русскоязычная и англоязычная литература следуют разным подходам. Кроме того несколько авторитетных специалистов по экономике и теории игр предлагают свои варианты классификации.
...
Если игроки делают свой ход одновременно или не знают о предыдущем ходе соперника, игра называется **параллельной**. Такой порядок ходов выполняется в игре "камень-ножницы-бумага". В ней участники выбирают действие одновременно.
...
Для игр одного типа сумма выигрышей остаётся постоянной для всех исходов. Для игр другого типа, эта сумма отличается в зависимости от исхода. Например, в успешной торговой сделке оба участника могут получить выгоду. В этом случае говорят об **игре с ненулевой суммой**.

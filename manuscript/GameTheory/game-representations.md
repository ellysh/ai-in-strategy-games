...
Если изменить условия игры, то изменится и её решение. Допустим, Работодатель и Работник заключают контракт, имеющий юридическую силу. Тогда Работодатель сможет потребовать от Работника компенсации за плохую работу через суд. В этом случае выигрыши меняются. В исходе узла e Работник получит не 3, а меньше в зависимости от суммы штрафа. Тогда ему невыгодно отвечать плохой работой на высокую зарплату.

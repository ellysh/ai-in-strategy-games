...
Мы рассмотрели несколько последовательных и параллельных игр. Теория игр моделирует реальные ситуации из различных сфер социальной жизни. Подобная ситуация слишком сложна для того, чтобы свести её к простой игре. Но построить модели в этом случае можно, если скомбинировать несколько последовательных и параллельных игр.

Рассмотрим пример. Игрок, которого мы назовём Предприниматель, собирается основать стартап. На первом ходу игры, он должен оценить риски и решить: инвестировать свои деньги в стартап или отказаться от этой идеи.

Допустим, что Предприниматель инвестирует в стартап. На рынке уже есть другой игрок, назовём его Конкурент, который выпускает аналогичную продукцию. Спустя какое-то время Конкурент замечает появление стартапа. Дальше он выбирает: либо начать [**ценовую войну**](https://ru.wikipedia.org/wiki/Ценовая_война) с Предпринимателем за потребителей, либо купить стартап.

Чтобы смоделировать ситуацию из нашего примера, нам понадобится одна последовательная  игра и одна параллельная. Иллюстрация 1-4 демонстрирует выигрыши Предпринимателя и Конкурента.

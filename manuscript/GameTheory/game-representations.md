...
{caption: "Иллюстрация 1-11. Дерево игры Дарообмен", height: "50%", width: "100%"}
...
В игре "Стоножка" участвуют два игрока. Они по очереди выбирают одно из двух действий: взять стопку монет на столе или передать ход. При передаче хода, стопка монет увеличивается в два раза. Если никто из участников не берёт стопку монет, игра заканчивается на сотом ходу. В этом случае никто не получает деньги.

Для примера назовём участников Алиса и Боб. Иллюстрация 1-2 демонстрирует дерево игры "Стоножка".

{caption: "Иллюстрация 1-11. Дерево игры Стоножка", height: "50%", width: "100%"}
[Дерево игры Стоножка](images/GameTheory/centipede-game-tree.png)

### Нормальная форма игры

#### Игра "Дилемма Заключённых"

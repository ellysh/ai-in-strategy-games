...
Игра "Дарообмен" моделирует рынок труда. В игре два участника: Работодатель и Работник. Работодатель предлагает Работнику зарплату. Работник не может отказаться от зарплаты. Он принимает её и тратит на работу определённые усилия.
...
Обратная индукция предлагает рассматривать ходы игроков с конца. Таким образом мы находим наилучший выбор участника, который ходит последним. Затем с учётом этого, ищем наилучший предпоследний ход. Повторяем анализ шагов до тех пор, пока не придём к первому ходу в партии.

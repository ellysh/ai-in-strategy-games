...
Теперь представим игру "дилемма заключённого" в нормальной форме. Для этого построим таблицу. Её строки соответствуют стратегиям первого игрока, а столбцы — стратегиям второго. В каждой ячейки таблицы указываются выигрыши обоих участников, если они выберут стратегии из соответствующих строки и столбца.

Таблица 1-4 демонстрирует нормальную форму игры "дилемма заключённого".

{caption: "Таблица 1-4. Нормальная форма игры дилемма заключённого", width: "70%"}
|  | Мэллори, молчать | Мэллори, дать показания |
| --- | --- | --- |
| Чак, молчать | -1, -1 | -3, 0 |
| Чак, дать показания | 0, -3 | -2, -2 |

Первое число в каждой ячейке означает выигрыш Чака, а второе — выигрыш Мэллори.
